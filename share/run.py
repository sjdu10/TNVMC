...
if __name__ == "__main__":
    set_options(deterministic=False,pbc=True,max_bond=chi)

    if step == 0:
        # fpeps = load_tn_from_disc(f'../tmpdir/su_{Lx},{Ly}_rand')
        fpeps = load_tn_from_disc(f'/home/sdu2/TNVMC/data/time_cost/states/psi_{D}_10')
    elif step != 0:
    ...
    burn_in = 10 # burn-in steps number!!4100101
